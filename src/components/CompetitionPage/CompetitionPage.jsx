...
export default function CompetitionPage(props) {
    ...
    const {token: API_TOKEN, leagueList, teamList, returnLeagueList, returnTeamList} = props;
    ...
    return (
        <Switch>
            ...
            <Route path="/leagues/:id/calendar" >
                <Calendar type="competitions" API_TOKEN={API_TOKEN} teams={teamList} calendarOwners={leagueList} /> 
            </Route>
